...
Assume our existing website converts 50% of customers to paying subscriptions.<br> We have new website that we think generates a lift of 101% --- or a delta-to-control = `{python} f"{control_mean*(index_to_control-1):.2%}"`.
...
control_samples, treatment_samples = two_proportion_required_samples(
    ...
    treatment_rate = control_mean*index_to_control,
    control_to_treatment_ratio=1,
    tail_type="one_tail")
